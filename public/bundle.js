...
function render(variables = {}) {
  ...
  if (variables.socialMediaPosition == "") variables.socialMediaPosition = "position-right";
  ...
  if (variables.includePicture == true) variables.avatarURL = "./assets/img/Cajon1.jpg";
